...
QT_MOC_LITERAL(1, 7, 21), // "finishedImgFeatureSig"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 6) // "string"

    },
    "Thread\0finishedImgFeatureSig\0\0string"
};
...
void Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->finishedImgFeatureSig((*reinterpret_cast< const string(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Thread::*_t)(const string & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Thread::finishedImgFeatureSig)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Thread::finishedImgFeatureSig(const string & _t1)
{
